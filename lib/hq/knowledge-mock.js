...
export const sooklyHubLinks = [
  ...
  },
  {
    ...
    subtitle: "What can the AI safely say? Consumes SEOS Knowledge Base",
    badge: "67%",
  },
  {
...
export const knowledgeUsage = [
  { intent: "Opening hours enquiry", channel: "LINE", kbId: "faq-hours", label: "What are your opening hours?", status: "workflow_ready" },
  { intent: "First visit preparation", channel: "Website chat", kbId: "faq-first", label: "What should first-time patients bring?", status: "workflow_ready" },
  ...
  { intent: "Cancellation policy", channel: "All channels", kbId: "pol-cancel", label: "Cancellation Policy", status: "workflow_ready" },
...
export const distributionRows = [
  ...
  { channel: "Schema.org", fieldGroup: "LocalBusiness", status: "workflow_ready", lastSynced: "1 week ago" },
  { channel: "Google Business Profile", fieldGroup: "Hours & NAP", status: "future_api" },
  { channel: "Sookly chatbot", fieldGroup: "Approved FAQs", status: "workflow_ready", lastSynced: "Static Phase 2" },
];
