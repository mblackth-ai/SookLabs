...
export const nav = [
  { kind: "section", label: "Executive" },
  { kind: "item", id: "executive", label: "Overview", icon: "briefcase", href: "/hq" },
  { kind: "item", id: "briefing", label: "Daily Briefing", icon: "book", href: "/hq/briefing" },
  { kind: "section", label: "SEOS" },
  { kind: "item", id: "seos", label: "SEOS Hub", icon: "trending", href: "/hq/seos" },
  { kind: "item", id: "kb", label: "Knowledge Base", icon: "book", href: "/hq/seos/knowledge-base" },
  { kind: "item", id: "semantic", label: "Semantic Readiness", icon: "cpu", href: "/hq/seos/semantic-readiness" },
  { kind: "item", id: "gaps", label: "Content Gaps", icon: "alert", href: "/hq/seos/content-gaps" },
  { kind: "item", id: "competitors", label: "Competitor Signals", icon: "grid", href: "/hq/seos/competitor-signals" },
  { kind: "item", id: "distribution", label: "Distribution Map", icon: "plug", href: "/hq/seos/distribution-map" },
  { kind: "item", id: "exports", label: "Exports", icon: "zap", href: "/hq/seos/exports" },
  { kind: "section", label: "Sookly" },
  { kind: "item", id: "sookly", label: "Product Status", icon: "activity", href: "/hq/sookly" },
  { kind: "item", id: "action-plan", label: "Action Plan", icon: "zap", href: "/hq/sookly/action-plan" },
  { kind: "item", id: "receptionist", label: "Receptionist Readiness", icon: "cpu", href: "/hq/sookly/receptionist-readiness" },
  { kind: "item", id: "usage", label: "Knowledge Usage", icon: "book", href: "/hq/sookly/knowledge-usage" },
  ...
  { kind: "item", id: "automation", label: "Automation Registry", icon: "zap", href: "/hq/automation" },
...
export const products = [
  ...
  {
    name: "SEOS",
    tagline: "SookLabs Expansion Operating System",
    status: "in progress",
    eta: "Phase 2",
    phase: "Knowledge Base · static",
    desc: "Expansion OS with canonical Knowledge Base for visibility, semantic readiness, and distribution.",
    href: "/hq/seos",
  },
  {
    name: "RoastMyOpSec",
