...
/** SEOS product app URL — set NEXT_PUBLIC_SEOS_URL in env. Prod default avoids localhost traps. */
export function getSeosAppUrl() {
  return (process.env.NEXT_PUBLIC_SEOS_URL || "https://seos.sooklabs.com").replace(/\/$/, "");
}
